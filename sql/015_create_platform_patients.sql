2026-05-22T10:48:55.173727Z [info     ] db_logging_enabled             slow_threshold_ms=500
BEGIN;

-- Running upgrade 015_create_platform_patients -> 016_create_platform_patient_fields
...
ALTER TABLE platform_patient_fields ADD CONSTRAINT fk_platform_patient_fields_superseded_by FOREIGN KEY(superseded_by_id) REFERENCES platform_patient_fields (id);

UPDATE alembic_version SET version_num='016_create_platform_patient_fields' WHERE alembic_version.version_num = '015_create_platform_patients';

-- Running upgrade 016_create_platform_patient_fields -> 017_create_platform_credit_products
...
CREATE TABLE platform_credit_products (
    ...
    status platform_credit_product_status DEFAULT 'draft' NOT NULL, 
    ...
    decision_ruleset VARCHAR NOT NULL, 
...
UPDATE alembic_version SET version_num='017_create_platform_credit_products' WHERE alembic_version.version_num = '016_create_platform_patient_fields';

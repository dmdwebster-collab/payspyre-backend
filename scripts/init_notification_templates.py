...
DEFAULT_TEMPLATES = [
    ...
    },
    {
        ...
        "type": "sms",
        "category": "application_status",
        "body_template": "PaySpyre: Your loan application for {{ amount }} was not approved. Contact us at support@payspyre.com for details or to discuss options. We're here to help.",
        "variables": ["amount"],
    },
    {
        ...
        "type": "sms",
        "category": "payment_reminder",
        "body_template": "PaySpyre: Payment of {{ payment_amount }} due on {{ due_date }} ({{ days_until_due }} days). Pay now: {{ payment_url }} Reply STOP to opt out.",
    ...
    },
    {
        ...
        "type": "sms",
        "category": "payment_reminder",
        "body_template": "PaySpyre: Payment OVERDUE by {{ days_overdue }} days. Amount: {{ payment_amount }}. Pay now: {{ payment_url }} Contact us at support@payspyre.com.",
    ...
    },
    {
        ...
        "type": "sms",
        "category": "urgent",
        "body_template": "URGENT PaySpyre: {{ alert_title }}. Action required by {{ deadline }}. {{ time_remaining }} remaining. Details: {{ action_url }} Contact us at support@payspyre.com immediately.",
    ...
    },
    {
        ...
        "type": "sms",
        "category": "application_status",
        "body_template": "PaySpyre: We need documents to process your application. Upload by {{ deadline }}: {{ upload_url }} {{ document_count }} document(s) needed. Contact us at support@payspyre.com with questions.",

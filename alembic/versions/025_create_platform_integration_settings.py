...
# NOTE: re-rooted during the 2026-06-19 reconciliation onto main's head
# (027_processed_webhooks_idempotency). main independently added 025/026/027
# migrations; this branch's 025-028 now chain ABOVE them. The "025_" filename
# prefix is retained for git history continuity — alembic orders by the
# revision/down_revision graph, not the filename. (Cosmetic renumber is a
# follow-up.)
revision: str = "025_create_platform_integration_settings"
down_revision: Union[str, None] = "027_processed_webhooks_idempotency"

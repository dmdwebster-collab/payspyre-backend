...
class Vendor(Base):
    ...
    onboarding_documents = relationship("VendorOnboardingDocument", back_populates="vendor")


class VendorOnboardingDocument(Base):
    __tablename__ = "vendor_onboarding_documents"
    ...
    document_type = Column(
        Enum("business_license", "incorporation", "tax_id", "insurance", "w9", "other", name="document_type"),
        nullable=False,
    )
    ...
    # Review status
    status = Column(
        Enum("pending", "approved", "rejected", name="document_status"),
        nullable=False,
        default="pending",
    )
    ...
    # Relationships
    vendor = relationship("Vendor", back_populates="onboarding_documents")

    __table_args__ = (
        Index("idx_vendor_doc_vendor", "vendor_id"),
        Index("idx_vendor_doc_type", "document_type"),
